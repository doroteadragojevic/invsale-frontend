...
export default function View() {
                ...
                <div key={product.idProduct} className="product-card">
                  <div className="product-image-container">
                    ...
                    <div className="overlay">
                      <button onClick={() => navigate('/product', { state: { productId: product.idProduct, isLoggedIn: false } })} className="view-button">VIEW</button>
                    </div>
                  </div>
  ...
  {isLoggedIn ? (
    ...
    available <= 0 ? (
      ...
      <div className="not-available">Login to order</div>
    )
  )}
</div>
